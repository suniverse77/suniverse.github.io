...
$$
\frac{\mathbf{x}_{t - \Delta t}}{\sqrt{\alpha_{t - \Delta t}}}
=
\frac{\mathbf{x}_t}{\sqrt{\alpha_t}}
+
\left(
\sqrt{\frac{1 - \alpha_{t - \Delta t}}{\alpha_{t - \Delta t}}}
-
...
이에 대응하는 ODE를 유도하기 위해 $\frac{\sqrt{1-\alpha}}{\sqrt{\alpha}}=\sigma$, $\frac{\mathbf{x}}{\sigma}=\bar{\mathbf{x}}$로 치환하여 아래의 식으로 정리하였다.
...
<center><img src='{{"/assets/images/논문리뷰/DDIM-3.png" | relative_url}}' width="80%"></center>
...
<center><img src='{{"/assets/images/논문리뷰/DDIM-5.png" | relative_url}}' width="100%"></center>
