...
<center><img src='{{"/assets/images/논문리뷰/VideoLDM-2.png" | relative_url}}' width="100%"></center>
...
$$
\underset{\phi}{\argmin}\mathbb{E}_{}\big[\lVert\mathbf{y}-\mathbf{f}_{\theta,\phi}(\mathbf{z}\_\tau;\mathbf{c},\tau)\rVert\big]
$$
