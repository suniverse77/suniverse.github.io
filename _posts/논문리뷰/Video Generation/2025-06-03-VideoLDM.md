...
<center><img src='{{"/assets/images/논문리뷰/VideoLDM-5.png" | relative_url}}' width="30%"></center>

$$
\underset{\phi}{\text{argmin}}~\mathbb{E}_{\mathbf{x}}\big[\lVert\mathbf{y}-\mathbf{f}_{\theta,\phi}(\mathbf{z}\_\tau;\mathbf{c},\tau)\rVert\big]
$$
