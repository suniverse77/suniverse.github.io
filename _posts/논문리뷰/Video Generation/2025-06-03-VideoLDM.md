...
<center><img src='{{"/assets/images/논문리뷰/VideoLDM-9.png" | relative_url}}' width="100%" alt="Video LDM으로 생성한 1280×2048 해상도의 샘플"></center>

Dreambooth로 개인화된 텍스트-비디오 생성

<center><img src='{{"/assets/images/논문리뷰/VideoLDM-11.png" | relative_url}}' width="100%"></center>