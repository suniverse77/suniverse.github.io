...
<center><img src='{{"/assets/images/논문리뷰/T2VZ-1.png" | relative_url}}' width="70%"></center>
...
- $\hat{x}_t^k$: $x_t^1$에 대 warping operation $W_k$를 적용한 latent code
- $M^k$: salient objection detection을 적용해 얻은 foreground mask

### Conditional and Specialized Text-to-Video

<center><img src='{{"/assets/images/논문리뷰/T2VZ-3.png" | relative_url}}' width="70%"></center>
