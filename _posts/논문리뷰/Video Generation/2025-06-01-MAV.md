...
- $Conv_{2d}$ 입력 전: $h\in\mathbb{R}^{BF\times C\times H\times W}$
- $Conv_{1d}$ 입력 전: $h\in\mathbb{R}^{BHW\times C\times F}$
...
- $Conv_{2d}$ 입력 전: $h\in\mathbb{R}^{BF\times HW\times C}$
- $Conv_{1d}$ 입력 전: $h\in\mathbb{R}^{BHW\times F\times C}$
